...
:PROPERTIES:
:ONE: one-default
:CUSTOM_ID: /blog/gptel-org/
:END:

I am a huge fan of [[https://github.com/karthink/gptel][gptel]] and I use it daily as my main mode of communication with various LLM providers. One of the main uses I get from LLMs is when I'm learning or exploring new technologies. I've set it up to take org-mode text as input and to of course output text in org-mode as well. It comes pretty handy since everything is happening inside emacs, and it's also useful for writing and note-taking which I almost exclusively do inside Emacs in org-mode, unless I'm forced to do otherwise.
